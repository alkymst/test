...
function converio_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'installing'                      => esc_attr__( 'Installing Plugin: %s', 'tgmpa' ), // %s = plugin name.
            ...
            'complete'                        => esc_attr__( 'All plugins installed and activated successfully. %s', 'tgmpa' ), // %s = dashboard link.
